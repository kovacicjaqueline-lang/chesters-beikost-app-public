...
- im GitHub-App-Workflow wird dieselbe geordnete Browserliste deterministisch auf drei Shards verteilt; zusammen müssen alle drei Shards die vollständige Liste abdecken,
