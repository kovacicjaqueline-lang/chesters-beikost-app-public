...
(function installTargetedActionRenderScopes(root) {
  ...
  const clickRules = [
    ...
    [".removeManualMeal", "current", true],
    [".removePlannedMeal", "current", true],
    ["#confirmPlanRebuild", "current", false],
    ["#reactivateRequiredFood", "current", false],
    ["#applyPlanGoalSolution", "current", false],
    ["#applyHardCorrection", "current", false],
    ["[data-readiness-signal]", "current", false],
    ["#shiftOpenPlans", "current", false],
    ["#keepOpenPlans", "current", false],
    ["#backfillOpenPlans", "current", false],
    ["#moveReplace", "current", false],
    ["#moveNextFree", "current", false],
  ];
  const changeRules = [
    ["#planFrom", "plan", false],
