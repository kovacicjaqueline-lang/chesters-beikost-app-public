...
test("HANDLING offline: dynamisch geladener Contract und Runtime sind beim ersten Offline-Start vorgecached", () => {
  ...
  assert.match(
    swSource,
    /\.\.\.PLAN08_PRECACHE\s*,\s*\.\.\.HANDLING_PRECACHE\s*,\s*\.\.\.UI_PRECACHE/,
  );
});
