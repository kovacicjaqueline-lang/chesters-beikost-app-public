...
test("PLAN-08 P0: Loader installiert Proactive Recipe-first, Rollenstabilität, Qualitätsrotation und Einführungspolicy vor dem sichtbaren Abschlussrender", () => {
  ...
  assert.match(utils, /installPlannerIntroductionPolicyRuntime\(\);\s*finishPlannerPolicies\(\);/);
});